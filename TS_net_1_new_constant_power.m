function [sys,x0,str,ts,simStateCompliance] = TS_net_1_new_constant_power(t,x,u,flag,busdata,linedata,VSS0,LINE,fbus,ng,Currentin_idx,amp)
%VSS0初始电压幅值数据（来自潮流结果）；fbus是一个特殊母线编号，用于某些扰动；ng是发电源的个数；Currentin_idx是；amp是一个导纳扰动参数
...
switch flag
  ...
  %%%%%%%%%%%%%%%%%%
  case 0
    [sys,x0,str,ts,simStateCompliance,YY0,Yff,YGB,YGBd,YGBq,Yng1,Ynn1]=mdlInitializeSizes(busdata,linedata,VSS0,LINE,nBus,Currentin_idx,fbus,ng,amp);
  ...
  %%%%%%%%%%%
  case 3
    sys=mdlOutputs(t,x,u,busdata,linedata,YY0,Yff,fbus,ng2,ii,ii2,ii6,YGB,YGBd,YGBq,Yng1,Ynn1,Currentin_idx,ng);
...
%=============================================================================
%
function [sys,x0,str,ts,simStateCompliance,YY0,Yff,YGB,YGBd,YGBq,Yng1,Ynn1]=mdlInitializeSizes(busdata,linedata,VSS0,LINE,nBus,Currentin_idx,fbus,ng,amp)
...
%=============================================================================
%
function sys=mdlOutputs(t,x,u,busdata,linedata,YY0,Yff,fbus,ng2,ii,ii2,ii6,YGB,YGBd,YGBq,Yng1,Ynn1,Currentin_idx,ng)
nBus=size(busdata,1);
Y=YY0;
%%            ====================
