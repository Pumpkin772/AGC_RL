function [sys,x0,str,ts,simStateCompliance] = TS_net_1_new(t,x,u,flag,YY_load,ng,loadnode,loadsize)
...
P_list = [];
deltaP_list=[];
Pref_list=[-8.3236 1.4130 2.8434 -8.6431];
for i = 1:4
    k = k_list(i);
