...
[    
        ...
        2         2.67      0.049    0.065       0    0      1     8     50    0.1   0       2.828 
        3         2.67      0.049    0.065       0    0      1     8     50    0.1   0       2.828   
        4         2.67      0.049    0.065       0    0      1     8     50    0.1   0       2.828 
        5         2.67      0.049    0.065       0    0      1     8     50    0.1   0       2.828 
        6         2.67      0.049    0.065       0    0      1     8     50    0.1   0       2.828     
        7         2.67      0.049    0.065       0    0      1     8     50    0.1   0       2.828          
];
Wind_machine_data = Wind_machine_data((1:length(AggWind_in_gidx)),:);
%
%，
...
[
        ...
        2          100,6000    0.95,1     -0.5,-1.2    0.1,0.1    0.5,5    2,5        1,20    2,5
        3          100,6000    0.95,1     -0.5,-1.2    0.1,0.1    0.5,5    2,5        1,20    2,5
        4          100,6000    0.95,1     -0.5,-1.2    0.1,0.1    0.5,5    2,5        1,20    2,5
        5          100,6000    0.95,1     -0.5,-1.2    0.1,0.1    0.5,5    2,5        1,20    2,5
        6          100,6000    0.95,1     -0.5,-1.2    0.1,0.1    0.5,5    2,5        1,20    2,5      
        7          100,6000    0.95,1     -0.5,-1.2    0.1,0.1    0.5,5    2,5        1,20    2,5           
];
Wind_mach_PI = Wind_mach_PI((1:length(AggWind_in_gidx)),:);
%% 
...
%% 
         ...
         Pw          =    opdata(AggWind_in_gidx,2)./(NN.*SwgBi);%
         Qw          =    opdata(AggWind_in_gidx,3)./(NN.*SwgBi);
         Um          =    opdata(AggWind_in_gidx,4);
         Atheta      =    opdata(AggWind_in_gidx,5)*pi/180;
 
         
         PwA        =    opdata(AggWind_in_gidx,2)./(NN.*SwgBi);
