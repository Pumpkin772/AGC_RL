...
EStorage_in_gidx    =    [1 2 3 4 5 6 7 8];

AggWind_in_gidx     =    [1 2 3 4 5 6 7];
AggWind_in_gidx2     =    [32];
Currentin_idx = [8 21 30:39];
%  Single fan capacity 
AggSwgB           =    [2;2;2;2;2;2;2];%2MVA
%  Number of aggregate fans; 
AggNN             =    [340;50;50;50;50;50;50];%a DFIG model represent 50 DFIGs
%  Rotor Speed of DFIG 
AggWr0            =    [0.9;0.9;0.9;0.9;0.9;0.9;0.9];% 初始转速（pu）
...
commun = ones(length(EStorage_in_gidx),2);
commun = 0*commun;