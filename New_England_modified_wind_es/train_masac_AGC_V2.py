...
def train2(args):
    ...
    for ep in range(max_episodes):
        ...
        eng.set_param(env_name, 'StopTime', str(600.0), nargout=0)
        ...
        step_max= int(round(200.0/PauseTime))
        while True:
            ...
            if ModelStatus == 'paused':
                ...
                states, rewards, rewardsA, rewardsF = state_reward_AGC_V2(data, agent_num, counter_step,step_max,args,
