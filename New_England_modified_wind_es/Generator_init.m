...
gendata=...
[
    1   1.000/10   0.690/10  0.310/10  0.310/10   0.25/10  0.25/10   10.20  1.500  0.03  0.05  4.200*10  10   100;
    2   2.950/10   2.820/10  0.697/10  0.697/10   0.25/10  0.25/10   6.560  1.500  0.03  0.05  3.030*10  10   100;
    3   2.495/10   2.370/10  0.531/10  0.531/10   0.25/10  0.25/10   5.700  1.500  0.03  0.05  3.580*10  10   100;
    4   2.620/10   2.580/10  0.436/10  0.436/10   0.25/10  0.25/10   5.690  1.500  0.03  0.05  2.860*10  10   100;
    5   6.700/10   6.200/10  1.320/10  1.320/10   0.25/10  0.25/10   5.400  0.440  0.03  0.05  2.600*10  10   100;
    6   2.540/10   2.410/10  0.500/10  0.500/10   0.25/10  0.25/10   7.300  0.400  0.03  0.05  3.480*10  10   100;
    7   2.950/10   2.920/10  0.490/10  0.490/10   0.25/10  0.25/10   5.660  1.500  0.03  0.05  2.640*10  10   100;
    8   2.900/10   2.800/10  0.570/10  0.570/10   0.25/10  0.25/10   6.700  0.410  0.03  0.05  2.430*10  10   100;
    9   2.106/10   2.050/10  0.570/10  0.570/10   0.25/10  0.25/10   4.790  1.960  0.03  0.05  3.450*10  10   100;
   10   0.200/10   0.190/10  0.060/10  0.060/10   0.25/10  0.25/10   7.000  0.700  0.03  0.05  50.00*10  5   100; 
];
gendata = gendata(Syn_Machidx_g,:);
Xd=gendata(:,2);
Xq=gendata(:,3);
Xd1=gendata(:,4);
Xq1=gendata(:,5);
...
[
    ...
    1     0.15   0.17    0.25      7.0      -7.0
    1     0.15   0.17    0.25      7.0      -7.0
    1     0.15   0.17    0.25      7.0      -7.0%10
];
Govnerdata=Govnerdata(Syn_Machidx_g,:);
...
Excitdata=Excitdata(Syn_Machidx_g,:);
...
[
    ...
    1   15    10   0.07     0.03    0.07    0.03     0.1    -0.1;
    1   15    10   0.07     0.03    0.07    0.03     0.1    -0.1;
    0   15    10   0.07     0.03    0.07    0.03     0.1    -0.1;
    0   15    10   0.07     0.03    0.07    0.03     0.1    -0.1;
    0   15    10   0.07     0.03    0.07    0.03     0.1    -0.1;
    0   15    10   0.07     0.03    0.07    0.03     0.1    -0.1;
    0   15    10   0.07     0.03    0.07    0.03     0.1    -0.1;
    0   15    10   0.07     0.03    0.07    0.03     0.1    -0.1;%10  
];
